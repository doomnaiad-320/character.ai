...
export default function CreatePersona() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post(`/persona`, formDataToSend, {
        headers: {
      ...
      toast.error(`Failed to create persona: ${errorMessage}`);
      console.error(error);
    } finally {
  ...
  return (
    <>
    <BackgroundDesign />
    <div className="h-full w-full flex justify-center py-10 overflow-y-auto px-4 sm:px-6 lg:px-8 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-rounded-full scrollbar-thumb-gray-800">
